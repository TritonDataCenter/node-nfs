...
function CreateCall(opts) {
    ...
    assert.optionalString(opts.where, 'opts.where');
...
CreateCall.prototype.writeHead = function writeHead() {
    ...
    if (this.how === create_how.EXCLUSIVE) {
        ...
        len += XDR.byteLength(this.obj_attributes);
    }
