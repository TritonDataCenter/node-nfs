...
util.inherits(FsStatReply, RpcReply);
...
FsStatReply.prototype._transform = function _transform(chunk, enc, cb) {
    if (this.incoming) {
        ...
        if (this.status === 0) {
            ...
            this.tbytes = xdr.readDouble();
            this.fbytes = xdr.readDouble();
            this.abytes = xdr.readDouble();
            this.tfiles = xdr.readDouble();
            this.ffiles = xdr.readDouble();
            this.afiles = xdr.readDouble();
...
FsStatReply.prototype.writeHead = function writeHead() {
    ...
    if (this.status === 0) {
        xdr.writeDouble(this.tbytes);
        xdr.writeDouble(this.fbytes);
        xdr.writeDouble(this.abytes);
        xdr.writeDouble(this.tfiles);
        xdr.writeDouble(this.ffiles);
        xdr.writeDouble(this.afiles);
